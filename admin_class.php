...
Class Action {
	...
	/*	$file=$_FILES['image']['tmp_name'];
		...
		$fil=$_FILES['img']['tmp_name'];
		$image1= addslashes(file_get_contents($_FILES['img']['tmp_name']));
		$im= addslashes($_FILES['img']['name']);			
		move_uploaded_file($_FILES["img"]["tmp_name"],"uploads/" . $_FILES["img"]["name"]);


		$iname="uploads/" . $image_name;
		$location="uploads/" . $im;
*/
		//====
		if(isset($_FILES['img']) && $_FILES['img']['tmp_name'] != '')
		...
		{
			$fname1 = strtotime(date('y-m-d H:i')).'_'.$_FILES['image']['name'];
			$move1 = move_uploaded_file($_FILES['image']['tmp_name'],'uploads/'. $fname1);
			$data .= ", image = '$fname1' ";
